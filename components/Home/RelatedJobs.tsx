...
const jobData = [
  ...
  },
  {
    ...
    role: "Volunteer Role", // Add this line
  },
  {
    id: 3,
    ...
    role: "Entry-Level", // Add this line
  },
  {
    id: 4,
        ...
        {jobData.map((job, index) => (
          <>
            ...
            >
              ...
              <h3 className="font-semibold text-lg mt-3 text-[#3B4D3F] cal_sans">
                {job.title}
              </h3>
              <p className="text-gray-600 text-sm mt-2 DM_sans">
                {job.company}
              </p>
              <p className="text-gray-700 font-medium flex items-center gap-2 mt-2 cal_sans">
                <LuWallet />
                {job.salary === "Not Paid" ? (
