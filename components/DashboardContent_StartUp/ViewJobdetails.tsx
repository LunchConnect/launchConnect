...
// import { HiDotsHorizontal } from "react-icons/hi";
// import { FiTrash2 } from "react-icons/fi";
// import { getSingleJob, SingleJobData } from "@/actions/action";
// import RecentApplication from "./RecentApplication";
...
//       const token =
//         "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImRmYjI0NTAzLTJlYTItNDlhNi1hMDI2LWFlYjQ3YmRkOGNmOCIsImVtYWlsIjoiY2hhbWJlcmV6aWdib0BnbWFpbC5jb20iLCJpYXQiOjE3NDQ2NTI4OTIsImV4cCI6MTc0NTI1NzY5Mn0.7JH6g3vxi4M-taA2orUBhyXx-bsWLCV1_luknlpX-QQ"; // will remove this soon after testing
//       try {
//         console.log("Fetching job with ID:", jobId);
//         const { job } = await getSingleJob(token, jobId); // Uses default token
//         setJob(job);
//       } catch (err) {
...
//           <div className="flex flex-row justify-between items-center space-y-4">
//             <div className="flex items-center gap-2">
//               {/* Removed imageUrl since it's not in SingleJobData */}
